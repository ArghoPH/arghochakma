    ...
    <div class="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 z-10">
        <div class="flex flex-col-reverse items-center gap-10 md:flex-row md:justify-between md:gap-12 lg:gap-16">
            ...
            <div class="w-full text-center md:w-1/2 md:text-left space-y-6">
                ...
                <div class="inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50/50 px-4 py-1.5 text-xs font-semibold tracking-wide text-blue-700 backdrop-blur-sm dark:border-blue-900/30 dark:bg-blue-950/40">
                ...
                <div class="space-y-3">
                    <p class="text-base sm:text-lg font-medium tracking-wide text-gray-500 dark:text-gray-400 text-center md:text-left">
                        Hi, my name is
                    </p>
                    ...
                    <h2 class="text-xl font-bold tracking-tight text-gray-700 sm:text-2xl md:text-3xl dark:text-gray-300">
                        Frontend Engineer & UI/UX Enthusiast
                    </h2>
                </div>

                <p class="max-w-xl mx-auto md:mx-0 text-sm sm:text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
                    I bridge the gap between design and code, crafting interactive visual systems that are
                    resilient, performant, and delightful to experience. Specialized in
                    <span class="font-semibold text-gray-900 dark:text-white">Vue.js, Tailwind CSS</span>, and
                    scalable architecture.
                </p>

                <div class="flex flex-col gap-4 sm:flex-row justify-center md:justify-start pt-2">
                    <RouterLink to="/projects"
                        class="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl bg-blue-600 px-6 py-3.5 font-semibold text-white shadow-lg shadow-blue-600/20 transition-all duration-300 hover:bg-blue-700 hover:shadow-blue-700/30 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 dark:shadow-none w-full sm:w-auto">
                        <span>Explore My Work</span>
                        <i class="fa-solid fa-arrow-right text-sm transition-transform duration-300 group-hover:translate-x-1"></i>
                    </RouterLink>

                    <RouterLink to="/contact"
                        class="inline-flex items-center justify-center rounded-xl border border-gray-300 bg-white px-6 py-3.5 font-semibold text-gray-700 transition-all duration-300 hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 w-full sm:w-auto">
                        Get In Touch
                    </RouterLink>
                </div>
            ...
            <div class="w-full md:w-1/2 flex justify-center mb-6 md:mb-0">
                <div class="relative group max-w-[260px] sm:max-w-[320px] md:max-w-[380px] w-full aspect-square">

                    <div class="absolute inset-0 rounded-3xl bg-gradient-to-tr from-blue-600 to-purple-600 opacity-20 blur-xl transition-all duration-500 group-hover:scale-105 group-hover:opacity-30">
                    </div>

                    <div class="relative h-full w-full overflow-hidden rounded-3xl border border-gray-200/50 bg-white p-3 shadow-2xl transition-all duration-500 group-hover:-translate-y-2 dark:border-gray-800/50 dark:bg-gray-900">
