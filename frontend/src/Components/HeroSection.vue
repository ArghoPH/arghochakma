...
<div class="mx-auto max-w-8xl w-4/5 px-6 lg:px-8 z-10">
    <div class="flex flex-col-reverse items-center gap-5 md:flex-row md:justify-between">
        ...
        <div class="w-full md:w-3/5 text-center md:text-left">
            ...
            <div class="space-y-4">
                <p
                    class="text-base font-medium tracking-wide text-gray-500 dark:text-gray-400 sm:text-lg">
                    Hi, my name is
                </p>
            ...
            <p
                class="mt-6 max-w-2xl text-base leading-relaxed text-gray-600 dark:text-gray-400 lg:text-lg">
            ...
            <div
                class="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center md:justify-start">
            ...
            <div class="mt-6 flex justify-center gap-6 text-xl md:justify-start">
                ...
                <a
                    href="https://linkedin.com/in/argho-chakma-0442561ba/"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <a
                    href="mailto:arghochakma7@gmail.com"
        ...
        <div class="w-full md:w-2/5 flex justify-center">
            ...
            <div class="relative group w-full max-w-[520px] aspect-square">
                ...
                <div
                    ...
                    <div
                        class="h-full w-full overflow-hidden rounded-2xl bg-slate-100 dark:bg-gray-800">
